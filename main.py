...
try:
    ser = serial.Serial('COM4', 115200)  # Reemplazar 'COM4' con el puerto serial correcto
...
while True:
    ...
    cpu_power = get_cpu_power_consumption_windows()  
    memory_usage = get_memory_usage()
    gpu_temp = get_gpu_temperature_windows()
    gpu_usage = get_gpu_usage_windows()

    # Enviar los datos a Heltec Wifi Kit 8
